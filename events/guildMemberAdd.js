...
function pmUserRules(user, client) {
  ...
  user.send(`Welcome to our Discord Server, The Satyr Farm/OpenSimWorld Discord Server! 
  ----- 
  ...
  *If you have any feedback, want to request a change, or add/remove something please send it in #feedback in a way that is well formatted and documented{code: 'asciidoc'});
}
